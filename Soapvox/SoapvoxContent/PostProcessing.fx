...
float4 PixelOut(float2 texCoord : TEXCOORD0, uniform bool computeEdge, 
...
technique EdgeDetect
{
    pass P0
    {
        PixelShader = compile ps_2_0 PixelOut(true, true);
    }
}
...
technique NoEdgeDetect
{
    pass P0
    {
        PixelShader = compile ps_2_0 PixelOut(false, true);
    }
}
...
technique NoCel
{
    pass P0
    {
        PixelShader = compile ps_2_0 PixelOut(false, false);
    }
}